...
const SideBar = (props) => {
	...
	return (
		<>
			...
			<div className="my-md-5 mt-2">
					...
					<NavLink
						...
						<div className="group text-nowrap">
							...
							<b
								...
								style={{
									color: location.pathname.startsWith("/pharmacy/dashboard")
										? "#303972"
										: "#c1bbeb",
								}}
								>
				...
				<NavLink
					...
					isActive={(match, location) =>
						location.pathname.startsWith("/pharmacy/invoices")
					}
					style={{
						borderTopLeftRadius: "50px",
						borderBottomLeftRadius: "50px",
						backgroundColor: location.pathname.startsWith("/pharmacy/invoices")
							? "#f3f4ff"
							: "transparent",
					}}
				...
				>
					<div
						...
						<div className="group text-nowrap">
							...
							<b className="text-deep mx-lg-4 mx-2" 
            //   style={{
            //     color: location.pathname.startsWith("/pharmacy/invoices")
            //       ? "#303972"
            //       : "#f3f4ff",
            //   }}
              >Invoice</b>
			...
			// 				 style={{
            //     color: location.pathname === "/pharmacy/invoices/invoice-pos"
            //       ? "#303972"
            //       : "#f3f4ff",
            //   }}
			  >
			...
			// 				  style={{
            //     color: location.pathname ==="/pharmacy/invoices/invoice-list"
            //       ? "#303972"
            //       : "#f3f4ff",
            //   }}
			  >
				...
				<NavLink
					...
					style={{
						borderTopLeftRadius: "50px",
						borderBottomLeftRadius: "50px",
						backgroundColor: location.pathname.startsWith("/pharmacy/orders")
							? "#f3f4ff"
							: "transparent",
					}}
					// style={({ isActive }) =>
				...
				<NavLink
					...
					className="d-flex move-left links align-items-start flex-column"
					isActive={(match, location) =>
						location.pathname.startsWith("/pharmacy/returns")
					}
					style={{
						borderTopLeftRadius: "50px",
						borderBottomLeftRadius: "50px",
						backgroundColor: location.pathname.startsWith("/pharmacy/returns")
							? "#f3f4ff"
							: "transparent",
					}}
					// style={({ isActive }) =>
				...
				>
					...
					<Collapse isOpen={isOpenReturn}>
						<div className="sublinks">
							...
							<Link
								to="/pharmacy/returns/invoice-return-list"
								className="sublink">
								Invoice Return List
							</Link>
				...
				<NavLink
					...
					isActive={(match, location) =>
						location.pathname.startsWith("/pharmacy/hrm")
					}
					style={{
						borderTopLeftRadius: "50px",
						borderBottomLeftRadius: "50px",
						backgroundColor: location.pathname.startsWith("/pharmacy/hrm")
							? "#f3f4ff"
							: "transparent",
					}}
					// style={({ isActive }) =>
				...
				<NavLink
					...
					style={{
						borderTopLeftRadius: "50px",
						borderBottomLeftRadius: "50px",
						backgroundColor: location.pathname.startsWith("/pharmacy/customers")
							? "#f3f4ff"
							: "transparent",
					}}
					// style={({ isActive }) =>
				...
				<NavLink
					...
					className="d-flex move-left links align-items-start flex-column"
					isActive={(match, location) =>
						location.pathname.startsWith("/pharmacy/manufacturer")
					}
					style={{
						borderTopLeftRadius: "50px",
						borderBottomLeftRadius: "50px",
