...
export const pharmacyEmail = (state) => state?.auth?.data?.email;
export const pharmacyPhoneContact = (state) => state?.auth?.data?.phone_number;
export const pharmacyLocation = (state) => state?.auth?.data?.location;
export const pharmacyAddress = (state) => state?.auth?.data?.gps_address;
